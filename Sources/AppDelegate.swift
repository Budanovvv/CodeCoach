...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func showSettings() {
        ...
        let window = makeWindow(title: L("CodeCoach Settings"), content: AnyView(view))
    ...
    private func showHistory() {
        ...
        let window = makeWindow(title: L("History"), content: AnyView(HistoryView()))
    ...
    private func showTrainer() {
        ...
        let window = makeWindow(
            title: L("Python Training"), content: AnyView(TrainerView(controller: controller)))
